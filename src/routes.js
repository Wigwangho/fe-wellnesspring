...
const kcal = React.lazy(()=> import('./views/statistics/kcal/kcal'))
const level = React.lazy(()=> import('./views/statistics/level/level'))
const sport = React.lazy(()=> import('./views/statistics/sport/sport'))
...
const routes = [
  ...
  { path: '/food', name: 'food', element: food },
  { path: '/kcal', name: 'kcal', element: kcal },
  { path: '/level', name: 'level', element: level },
  { path: '/sport', name: 'sport', element: sport },
